    ...
    <div className="flex-1 overflow-y-auto pb-20 sm:pb-24 md:pb-28 min-h-screen bg-gray-50">
      ...
      <div className="bg-white px-3 sm:px-4 py-3 sm:py-4 shadow-sm sticky top-0 z-10">
        <div className="flex items-center justify-between mb-2">
          <h1 className="text-lg sm:text-xl font-bold text-purple-600">Comunidad</h1>
          <button className="bg-purple-500 text-white w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-semibold text-xs sm:text-sm hover:bg-purple-600 transition-all duration-200 transform hover:scale-110 active:scale-95">
      ...
      <div className="px-3 sm:px-4 py-3 sm:py-4 space-y-4">
        ...
        <section className="animate-fadeInUp">
          <button
            ...
            className="w-full bg-purple-500 text-white py-3 px-4 rounded-xl font-semibold text-sm hover:bg-purple-600 transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center justify-center space-x-2"
          >
          ...
          <section className="animate-fadeInUp bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            ...
            <div className="flex justify-end space-x-2 mt-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              >
                Publicar
              </button>
            </div>
        ...
        <section className="space-y-4">
          {posts.map((post, index) => (
            <div
              key={post.id}
              className="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 animate-fadeInUp"
            ...
            >
              ...
              <div className="p-4 pb-3">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center space-x-3">
                    <div className="bg-purple-100 w-10 h-10 rounded-full flex items-center justify-center">
                      <span className="text-purple-600 font-semibold text-sm">{post.avatar}</span>
                    </div>
                    <div>
              ...
              {expandedPost === post.id && (
                <div className="border-t border-gray-100 p-4 pt-3 bg-gray-50">
                  {/* Existing Comments */}
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="flex-1 flex items-center space-x-2">
                      ...
                      <button
                        ...
                        className="p-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                      >
        ...
        <section className="animate-fadeInUp bg-white rounded-xl p-4 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="text-lg font-bold text-green-600">324</div>
