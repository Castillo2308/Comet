  ...
  return (
    <div className="flex-1 overflow-y-auto pb-20 min-h-screen">
      ...
      <div className="bg-white px-4 py-4 shadow-sm">
        ...
        <p className="text-gray-600 text-sm">Aquí puedes conocer más de tu cantón.</p>
      </div>

      <div className="px-4 py-4 space-y-4">
        {/* Reports Section */}
        <section className="animate-fadeInUp">
          <h2 className="text-lg font-semibold text-gray-800 mb-3">Tus reportes</h2>
        ...
        <section className="animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
          <h2 className="text-lg font-semibold text-gray-800 mb-3">Noticias importantes</h2>
