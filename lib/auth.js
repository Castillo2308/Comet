...
const ACCESS_EXPIRES_IN = process.env.JWT_EXPIRES || '7d';
...
// Treat these roles as privileged/admin-equivalent for backend actions
export function isPrivileged(role) {
  return ['admin','security','news','reports','buses','community'].includes(role);
}
