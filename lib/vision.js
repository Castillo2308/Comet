...
function contextMismatch(labels, text) {
  ...
  const positivesRaw = [
    'pothole','sinkhole','bache','baches','hueco','huecos','hoyo','hoyos','charco','puddle',
    'asfalto','asphalt','pavimento','paviment','tar','calle','calzada','via','carretera','intersection','interseccion',
    'basura','garbage','trash','street','road','signal','senal','accidente','flood','inundacion','alcantarilla','poste','arbol'
  ];
